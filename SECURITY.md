...
Les correctifs de sécurité sont appliqués uniquement aux versions **stables et récentes**  
...
| ------------- | ----------- |
| 🔍 Analyse / Review | La faille est évaluée et reproduite en interne. / The issue is reviewed and reproduced internally. |
| 🧱 Correctif / Fix | Un correctif est développé sur une branche privée. / A fix is developed on a private branch. |
| 🚀 Publication / Release | Une nouvelle version est publiée avec un avis de sécurité. / A new version is released with a security advisory. |
| 💬 Crédits / Credits | Le contributeur est mentionné s’il le souhaite. / Reporter is credited if desired. |
